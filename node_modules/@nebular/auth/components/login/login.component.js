...
import {NbEmailPassAuthProvider } from '../../providers';
var NbLoginComponent = /** @class */ (function () {
    ...
    NbLoginComponent.prototype.login = function () {
        ...
        this.submitted = true;
        this.service.authenticate(this.provider, JSON.stringify(this.user)).subscribe(function (result) {
            ...
            console.log(btoa('hak@inbox' + ':' + '123'));
            if (redirect) {
                setTimeout(function () {
